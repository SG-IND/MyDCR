...
public class CompleteCallActivity extends AppCompatActivity {
    AlertDialog dialog;
    ...
    TextView cdcename, cdchq, cdcdesig, cdcreportdate, cdcdname, cdcspeciality;
    EditText cdcdocfeedback;
    Spinner cdcactivityspinner, cdcresponsespinner;
    ImageView cdclogo, cdcuploadiview;
    String id, dname, speciality, reportdate, curr_month;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_call);
        ...
        cdcename = findViewById(R.id.cdcename);
        cdchq = findViewById(R.id.cdchq);
        cdcdesig = findViewById(R.id.cdcdesig);
        cdclogo = findViewById(R.id.cdclogo);
        cdcreportdate = findViewById(R.id.cdcreportdate);
        cdcdname = findViewById(R.id.cdcdname);
        cdcspeciality = findViewById(R.id.cdcspeciality);
        cdcactivityspinner = findViewById(R.id.cdcactivityspinner);
        cdcresponsespinner = findViewById(R.id.cdcresponsespinner);
        cdcuploadiview = findViewById(R.id.cdcuploadiview);
        cdcdocfeedback=findViewById(R.id.cdcdocfeedback);
        cdcresponsespinner.setEnabled(false);
        cdcuploadiview.setEnabled(false);
        cdcdocfeedback.setEnabled(false);
       cdcactivityspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
           @Override
           public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               if(position>0)
               {
                   cdcresponsespinner.setEnabled(true);
                   cdcuploadiview.setEnabled(true);
                   cdcdocfeedback.setEnabled(true);
               }
               else
               {
                   cdcresponsespinner.setEnabled(false);
        ...
        cdcename.setText(Html.fromHtml("E.Name: <b>" + name + "</b>"));
        cdchq.setText(Html.fromHtml("HQ: <b>" + hq + "</b>"));
        cdcdesig.setText(Html.fromHtml("Desig: <b>" + designation + "</b>"));
        Glide.with(CompleteCallActivity.this)
        ...
        cdcreportdate.setText(reportdate);
        cdcspeciality.setText(speciality);
        cdcdname.setText(dname);
        ...
        cdcresponsespinner.setAdapter(ad);

        curr_month = reportdate.substring(reportdate.indexOf("-") + 1, reportdate.lastIndexOf("-"));

        BackgroundProcess process = new BackgroundProcess(CompleteCallActivity.this);
        process.execute("cdcfetchproduct", webpath, c_id, curr_month);
    }

    public void showDialog(View view) {

        // Initialize alert dialog
        AlertDialog.Builder builder = new AlertDialog.Builder(CompleteCallActivity.this);
    ...
    private void LoadTable() {
        ...
        TableLayout tl = findViewById(R.id.cdctable);
        removeRows();
        ...
        try {
            for (int x = 0; x < langList.size(); x++) {
                ...
                for (int y = 0; y < rowval.length-1; y++) {
                ...
                etext.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder dialog1 = new AlertDialog.Builder(CompleteCallActivity.this)
                                .setTitle("Sample Quantity");
    ...
    public void loadActivity() {
        BackgroundProcess process = new BackgroundProcess(CompleteCallActivity.this);
        process.execute("cdcfetchactivity", webpath, c_id, curr_month);
    }
    ...
    public void loadActivitySpinner() {
        if (activitydata.length > 0) {
            ...
            ad.setDropDownViewResource(
                    android.R.layout
                            .select_dialog_singlechoice);
            cdcactivityspinner.setAdapter(ad);
        } else {
    ...
    {
        dialog=new AlertDialog.Builder(CompleteCallActivity.this)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == IMAGE_GALLERY && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                cdcuploadiview.setImageBitmap(bitmapLogo);
                uploadtoserver();
            } catch (IOException e) {
            }
    ...
    private void uploadtoserver() {
        if (imageloaded) {
            AlertDialog dialog = new AlertDialog.Builder(CompleteCallActivity.this)
                    .setTitle("Confirmation")
    ...
    public void ImageUploadToServerFunction(Bitmap bitmap, final String imageName, final String type, final String ecode, final String id, final String reportdate) {
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(CompleteCallActivity.this, String.format("%s is Uploading", type), "Please Wait", false, false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                AlertDialog display;
                display = new AlertDialog.Builder(CompleteCallActivity.this)
                        .setCancelable(true)
                        .create();
            ...
            protected String doInBackground(Void... params) {
                ...
                HashMapParams.put("doctor_id", id);

                HashMapParams.put("reportdate", reportdate);

                HashMapParams.put("type", type);

                String FinalData = imageProcessClass.ImageHttpRequest(webpath + "android/upload.php", HashMapParams);
    ...
    public void completecall(View view) {
        String activity, activityimage, activitypositiveresponse, activityfeedback, doctor_id, p_id, input, sampleqty;
        doctor_id = id;
        if (hasActivity && !cdcactivityspinner.getSelectedItem().toString().equals("No Activity")) {
            if (uploadedimage) {
                fetchLatLongAddress();
                activity = cdcactivityspinner.getSelectedItem().toString();
                activityimage = "";
                activitypositiveresponse = cdcresponsespinner.getSelectedItem().toString();
                activityfeedback = cdcdocfeedback.getText().toString();
        ...
        if (latitude != null && longitude != null) {
            BackgroundProcess process = new BackgroundProcess(CompleteCallActivity.this);
            process.execute("completecall", webpath, c_id, ecode, doctor_id, p_id, input, sampleqty, activity, activitypositiveresponse, activityfeedback, reportdate, latitude, longitude, uploadaddress);
    ...
    private void fetchLatLongAddress() {
        ...
        if (gps_enabled) {
            fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(CompleteCallActivity.this);
            ...
            fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    ...
                    if (location != null) {
                        ...
                        try {
                            Geocoder geocoder = new Geocoder(CompleteCallActivity.this, Locale.getDefault());
